...
public class PriorityQueue
{
    ...
    {
        this.data = new List<PathCube>();
    }

    // add an item to the queue and sort using a min binary heap
    public void Enqueue(PathCube item)
    {
    ...
    public bool Contains(PathCube item)
    {
        return data.Contains(item);
    }

    // return the data as a generic List
    public List<PathCube> ToList()
    {
        return data;
    }
